...
imgtub1.addEventListener("click",() => {
  imgMain.setAttribute("src", "img/juan/amazon1.jpg");
});
imgtub2.addEventListener("click",() => {
  imgMain.setAttribute("src", "img/juan/amazon2.jpg");
});
imgtub3.addEventListener("click",() => {
  imgMain.setAttribute("src", "img/juan/amazon3.jpg");
});
imgtub4.addEventListener("click",() => {
  imgMain.setAttribute("src", "img/juan/amazon4.jpg");
});
imgtub5.addEventListener("click",() => {
  imgMain.setAttribute("src", "img/juan/amazon5.jpg");
});
imgtub6.addEventListener("click",() => {
  imgMain.setAttribute("src", "img/juan/amazon6.jpg");
});
imgtub7.addEventListener("click",() => {
    imgMain.setAttribute("src", "img/juan/amazon7.jpg");
  });
